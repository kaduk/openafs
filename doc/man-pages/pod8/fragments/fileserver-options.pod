...
Sets values for many arguments in a manner suitable for a file server
with gigabytes of memory available to it.  Combine this flag with any
option except the B<-L> or B<-S> flags.

=item B<-L>

Present for historical compatibility.  Consider B<-X>.
